...
<div class=file>`r icon::fa("file", size = 1)` Prendre le fichier : <a href=https://trouver.datasud.fr/dataset/epanouissement-de-tous-les-etres-humains-indicateurs-de-developpement-durable>indicateurs de développement durable sur l'épanouissement des êtres humains</a></div>
...
<div class=file>`r icon::fa("file", size = 1)` Prendre le fichier : <a href=https://trouver.datasud.fr/dataset/indicateurs-communaux-de-qualite-de-lair-en-region-sud-provence-alpes-cote-dazur>Populations exposées au dépassement des valeurs de référence des PM10, NO2 et O3</a></div>
